...
def compile_to_gif(
    ...
    Saves to disk if a valid path within .cache/ is provided.
    """
    ...
    if export_to is not None:
        ...
        if ".cache" not in export_to:
            raise ValueError("[VISUALIZATION] Export path must be within .cache/ per directory hygiene standards.")
