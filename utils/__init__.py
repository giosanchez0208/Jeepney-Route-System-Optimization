...
- simulation.py -> SimulationSetup(city_query: str, config: dict, routes: list[Route]) -> None, SimulationResult(fitness_score: Optional[float] = None, metrics: Optional[dict[str, Any]] = None, recorded_paths: Optional[list[tuple[Any, float]]] = None, jeep_system: Optional[JeepSystem] = None, sim_id: Optional[str] = None, surrogate_cost: Optional[float] = None, score_kind: str = "fitness") -> None, and Simulation(city_query: str, bounds: tuple[float, float, float, float], jeep_system: JeepSystem, passenger_generator: PassengerGenerator, max_ticks: int, beta_penalty: float = 2.0, alpha_std_penalty: float = 0.5, config: Optional[dict] = None) -> None
