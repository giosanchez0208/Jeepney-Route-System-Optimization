"""Smoke test for notebooks/showcase_toy.ipynb and scripts/showcase_optimization.py.
...
from scripts.figures.fig_memetic import fig_hub_crossover, fig_pheromone_blend
