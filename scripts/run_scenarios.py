...
responds to agent heterogeneity. Reports the metric shift per archetype.
...
from scripts.analysis.analyze_benchmarks import transfer_stats


def sim_with_routes(city, ddm, config, route_objs):
    """Simulate a fixed set of Route objects under `config` (mirrors evaluate_runs._resim but takes
...
def main():
    from jeepney.pipeline import reuse_citygraph, reuse_ddm, generate_route_system
