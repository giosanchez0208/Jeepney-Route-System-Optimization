...
Strategies:
  ...
  D iter_sim_gate   : iterated sim-gated hill-climb (up to 3 accepted rounds, refreshing the gap each time).
    ...
    python -m scripts.analysis.mutator_experiment --bases 6 --k 3
"""
...
CFG = "configs/mutator_toy.yaml"


def build():
    from jeepney.optimizer import Optimizer
    from jeepney.route import RouteGenerator
...
def main():
    ...
    def copy_sys(routes):
        from jeepney.route import Route
