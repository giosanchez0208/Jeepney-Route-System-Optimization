...
Then just send back that one text file (a few KB). Nothing else needs to be pushed.
    ...
    python -m scripts.analysis.export_ablation           # auto-scans outputs/ablation_iligan/
    python -m scripts.analysis.export_ablation --root outputs/ablation_iligan --out export.txt
"""
