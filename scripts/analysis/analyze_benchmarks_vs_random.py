...
Metrics (baseline-random vs optimized), all from the simulated SimulationResults:
  ...
  - stop accessibility (864 m)         - route coverage (% drivable nodes served)
    ...
    python -m scripts.analysis.analyze_benchmarks_vs_random --k 7
...
from scripts.analysis.analyze_benchmarks import (transfer_stats, served_sets, accessibility, load_demand,
