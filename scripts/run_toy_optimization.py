...
Press play and leave. At the end it prints the run directory and the exact fig_optimization command.
    ...
    python -m scripts.run_toy_optimization
    python -m scripts.run_toy_optimization --routes 10 --generations 30 --population 20 --fleet 100
...
def main():
    ...
    print(f'    python -m scripts.figures.fig_optimization --run-dir "{opt_run.run_dir}"')
